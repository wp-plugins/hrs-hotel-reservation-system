      ...
      <div class="hotel_search_form_box">
        ...
        <form name="hotel_search_form" id="hotel_search_form" class="hotel_search_form" action="<?php //echo get_post_type_archive_link( 'gahb_hotel' ); ?>" method="get">
          <div class="dv_both_row">
            ...
            <div class="dv_col second-col-search-form">
            ...
            <div class="dv_col third-col-search-form">
            ...
            <div class="dv_col fourth-col-search-form">
            ...
            <div class="dv_col fifth-col-search-form">
            ...
            <div class="dv_col sixth-col-search-form">
            ...
            <div class="dv_col seventh-col-search-form">

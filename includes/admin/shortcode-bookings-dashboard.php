			...
			<div class="hotel_search_data_errors">
				...
				if( $booking_found ){
					...
					{?>
                        ...
                        <li class="booking_found_li_class"><?php echo $mydatarows[$i]->arrival_date; ?></li>
                        <li class="booking_found_li_class"><?php echo $mydatarows[$i]->departure_date; ?></li>
                        <li class="booking_found_li_class"><?php echo $mydatarows[$i]->payment; ?></li>
